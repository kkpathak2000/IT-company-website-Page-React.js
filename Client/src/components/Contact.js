      ...
      <div className="contact-image-container">
        ...
        <div className="contact-overlay">
          <div className="contact-info">
            ...
            <p><strong>Address:</strong> <a href="https://www.google.com/maps/search/?api=1&query=ABC+Street,+Lucknow" target="_blank" rel="noopener noreferrer" title="View on Google Maps">ABC Street, Lucknow</a></p>
            <p><strong>Phone:</strong> <a href="tel:+919876543210" title="Call IT Solutions Tech">+91-9876543210</a></p>
          </div>
