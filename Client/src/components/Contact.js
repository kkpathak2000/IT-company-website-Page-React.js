        ...
        <div className="contact-overlay">
          ...
          <Form id="form" className="contact-form" onSubmit={handleSend} aria-busy={isLoading}>
            <FormGroup>
              ...
              <Input type="text" name="name" id="name" value={formData.name} onChange={handleChange} placeholder="Your Name" required aria-required="true" maxLength={100} aria-describedby="name-counter" />
            ...
            <FormGroup>
              ...
              <Input type="email" name="email" id="email" value={formData.email} onChange={handleChange} placeholder="Your Email" required aria-required="true" maxLength={100} aria-describedby="email-counter" />
