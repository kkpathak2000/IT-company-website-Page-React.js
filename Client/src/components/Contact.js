      ...
      <div className="contact-image-container">
        ...
        <div className="contact-overlay">
          <div className="contact-info">
            ...
            <p><strong>Address:</strong> <a href="https://www.google.com/maps/search/?api=1&query=ABC+Street,+Lucknow" target="_blank" rel="noopener noreferrer" aria-label="View our address ABC Street, Lucknow on Google Maps">ABC Street, Lucknow</a></p>
